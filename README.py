...
try:
    ...
    print("                                       协议\n"
                    ...
                    "                         注意事项教学\n"
                    "--------------------------------------------------------------\n"
                    "打开Google，谷歌上面的桌面栏，分别为WhatsApps和Claude网站，记得请先登录，\n"
                    "并且在下方的桌面Google应用程序使用鼠标按住往左边滑直到为止，并放开，一切准备就绪后，\n"
                    "点击你下载的文件。\n"
                    ""
                    "如果没有按照上方指示操作，程序点击错误而导致意外进行风险操作，我们将不承担任何责任，并且请立刻回到终端按下CTRL+F2以立刻终止系统继续\n"
                    "如果要紧急退出程序，根据你打开的方式，分别为终端或IDLE Shell 在菜单中的位置，来按住win并根据位置按下数字，windows图标和桌面不属于\n"
                    "途中程序会打开专注模式，否则有通知可能会出错，您的手机可以登录相关账户并打开通知获取重要信息."
                    "")
    def again():
